 ...
 * @returns ReactNode
 */
const FarmDetailHigh: React.FunctionComponent<Props> = ({numFields}) => {
  const imgFloor = require('../../assets/farm-detail/high/floor.png');
  const imgValue = require('../../assets/farm-detail/high/value.png');
  const imgValueUp = require('../../assets/farm-detail/high/value-up.png');
  const imgEmpty = require('../../assets/farm-detail/high/empty.png');
  const imgEmptyUp = require('../../assets/farm-detail/high/empty-up.png');
  ...
  return (
    <View style={tw`flex-col items-center justify-center`}>
      ...
      <View style={tw`flex items-center justify-center`}>
        <Text style={tw`text-base font-RalewaySemiBold text-[#CB4B5A]`}>High</Text>
      </View>
    </View>
  );
};

export default FarmDetailHigh;
