 ...
 * @returns ReactNode
 */
const FarmDetailOptimal: React.FunctionComponent<Props> = ({numFields}) => {
  const imgFloor = require('../../assets/farm-detail/optimal/floor.png');
  const imgValue = require('../../assets/farm-detail/optimal/value.png');
  const imgValueUp = require('../../assets/farm-detail/optimal/value-up.png');
  const imgEmpty = require('../../assets/farm-detail/optimal/empty.png');
  const imgEmptyUp = require('../../assets/farm-detail/optimal/empty-up.png');
  ...
  return (
    <View style={tw`flex-col items-center justify-center`}>
      ...
      <View style={tw`flex items-center justify-center`}>
        <Text style={tw`text-base font-RalewaySemiBold text-[#26978D]`}>Optimal</Text>
      </View>
    </View>
  );
};

export default FarmDetailOptimal;
