    ...
    <SafeAreaView style={tw`h-1/1 bg-screenBackground flex-1 px-[1rem]`}>
        ...
        <View style={tw`flex-none w-6/7`}>
          <View style={tw`flex flex-row items-center rounded-2xl bg-white`}>
            <TextInput
              ...
              style={tw`w-full flex-none text-base font-RalewaySemiBold text-gray-500 py-2 px-3 no-underline decoration-transparent`}
            />
      ...
      <View style={tw`flex w-full mt-[2rem] h-6/7`}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <CustomerSupportCategory imgSrc="wheat" name="Benjamin Brown" location="Skaneateles, NY"/>
          <CustomerSupportCategory imgSrc="apple" name="Christopher Garcia" location="Woodstock, VT" />
          <CustomerSupportCategory imgSrc="banana" name="David Johnson" location="Mackinaw City, MI" />
          <CustomerSupportCategory imgSrc="orange" name="William Smith" location="Stowe, VT" />
        </ScrollView>
      </View>
